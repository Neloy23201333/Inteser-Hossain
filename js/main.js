...
var worksMasonryLayout = function() {
	var grid = document.querySelector('.works-video-grid');
	if (!grid) return;
	...
	var resizeGridItem = function(item) {
		...
		var styles = window.getComputedStyle(grid),
			...
			rowGap = parseInt(styles.getPropertyValue('gap'));
	...
	var resizeAll = function() {
		var items = grid.querySelectorAll('.work-video-card');
